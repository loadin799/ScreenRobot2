...
public final class UsersApi {
  ...
  public CountingIdlingResource getIdleResource(){
    if(mIdlingResource == null){
      mIdlingResource = new CountingIdlingResource("asd");
    }
    return mIdlingResource;
  }

  //Espresso Usage
  private void unregisterIdleResource() {
    if (mIdlingResource != null && !mIdlingResource.isIdleNow()) {
      mIdlingResource.decrement();
    }
  }

  //Espresso Usage
  private void registerIdleResource() {
    if (mIdlingResource != null) {
